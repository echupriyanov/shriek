...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20961 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20961 = (function (val,box,meta20962){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20961.cljs$lang$type = true;
cljs.core.async.impl.channels.t20961.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20961";
cljs.core.async.impl.channels.t20961.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t20961");
});
cljs.core.async.impl.channels.t20961.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20961.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20963){var self__ = this;
var _20963__$1 = this;return self__.meta20962;
});
cljs.core.async.impl.channels.t20961.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20963,meta20962__$1){var self__ = this;
var _20963__$1 = this;return (new cljs.core.async.impl.channels.t20961(self__.val,self__.box,meta20962__$1));
});
cljs.core.async.impl.channels.__GT_t20961 = (function __GT_t20961(val__$1,box__$1,meta20962){return (new cljs.core.async.impl.channels.t20961(val__$1,box__$1,meta20962));
});
}
return (new cljs.core.async.impl.channels.t20961(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_20964 = self__.takes.pop();if((taker_20964 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20964))
{var take_cb_20965 = cljs.core.async.impl.protocols.commit.call(null,taker_20964);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20965,taker_20964){
return (function (){return take_cb_20965.call(null,null);
});})(take_cb_20965,taker_20964))
);
} else
{}
{
