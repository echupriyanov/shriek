...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20955 = 0;while(true){
var m_20956 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20956 == null))
{} else
{m_20956.call(null);
if((count_20955 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20957 = (count_20955 + 1);
count_20955 = G__20957;
continue;
}
} else
{}
