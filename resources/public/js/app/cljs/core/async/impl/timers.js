...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20920 = 0;while(true){
if((i_20920 < arr.length))
{(arr[i_20920] = null);
{
...
{var i_20927 = (self__.level + 1);while(true){
if((i_20927 <= (new_level + 1)))
{(update[i_20927] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20929 = 0;while(true){
if((i_20929 <= self__.level))
{var links_20930 = (update[i_20929]).forward;if(((links_20930[i_20929]) === x__$1))
{(links_20930[i_20929] = (x__$1.forward[i_20929]));
{
var G__20931 = (i_20929 + 1);
i_20929 = G__20931;
continue;
}
} else
{{
var G__20932 = (i_20929 + 1);
i_20929 = G__20932;
continue;
}
}
