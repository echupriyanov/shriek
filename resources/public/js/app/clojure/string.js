...
{{
var G__16625 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16625;
continue;
}
} else
...
{var pred__16629 = cljs.core._EQ_;var expr__16630 = limit;if(cljs.core.truth_(pred__16629.call(null,1,expr__16630)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16629.call(null,2,expr__16630)))
...
var G__16632 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16633 = (limit__$1 - 1);
var G__16634 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16632;
limit__$1 = G__16633;
parts = G__16634;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16636 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16636))
{var replacement_16637 = temp__4090__auto___16636;buffer.append([cljs.core.str(replacement_16637)].join(''));
} else
{buffer.append(ch);
}
{
