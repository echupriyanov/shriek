...
goog.require('enfocus.core');
shriek.login.error_handler = (function error_handler(p__5592){var map__5594 = p__5592;var map__5594__$1 = ((cljs.core.seq_QMARK_.call(null,map__5594))?cljs.core.apply.call(null,cljs.core.hash_map,map__5594):map__5594);var status_text = cljs.core.get.call(null,map__5594__$1,new cljs.core.Keyword(null,"status-text","status-text",4371493274));var status = cljs.core.get.call(null,map__5594__$1,new cljs.core.Keyword(null,"status","status",4416389988));return console.log([cljs.core.str("Something bad happened: "),cljs.core.str(status),cljs.core.str(" "),cljs.core.str(status_text)].join(''));
});
...
shriek.login.login_not_ok = (function login_not_ok(p__5595){var map__5597 = p__5595;var map__5597__$1 = ((cljs.core.seq_QMARK_.call(null,map__5597))?cljs.core.apply.call(null,cljs.core.hash_map,map__5597):map__5597);var r = map__5597__$1;var status_text = cljs.core.get.call(null,map__5597__$1,new cljs.core.Keyword(null,"status-text","status-text",4371493274));var status = cljs.core.get.call(null,map__5597__$1,new cljs.core.Keyword(null,"status","status",4416389988));return console.log([cljs.core.str("Login not ok: "),cljs.core.str(status),cljs.core.str(" "),cljs.core.str(status_text),cljs.core.str("reponse"),cljs.core.str(cljs.core.pr_str.call(null,r))].join(''));
});
